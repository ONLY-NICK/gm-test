function HUD()
	...
	draw.RoundedBox(0,10,ScrH()-30,math.Clamp(client:Armor(),0,100)*2.25,15,Color(15,15,255,255))
	...
	if (client:GetActiveWeapon():IsValid()) then
		...
		if (curweapon != "weapon_physgun" and curweapon != "weapon_physcannon" and curweapon != "weapon_crowbar") then
	...
	local EXPLEVEL = (client:GetNWInt("LVL")*500)*2.5

	draw.RoundedBox(0,0,ScrH() - 145, 250, 40, Color(30,30,30,230))
	draw.SimpleText("Level: " .. client:GetNWInt("LVL"), "DermaDefaultBold", 10, ScrH() - 140, Color(255,255,255,255), 0)
	draw.SimpleText("EXP: " .. client:GetNWInt("EXP") .. "/" ..EXPLEVEL, "DermaDefaultBold", 10, ScrH() - 125, Color(255,255,255,255), 0)

	draw.RoundedBox(0, 255, ScrH() - 100, 125, 25, Color(30,30,30,230))
	draw.SimpleText("$: ".. client:GetNWInt("money"), "DermaDefaultBold", 260, ScrH()-95, Color(255,255,255,255), 0)
end
hook.Add("HUDPaint","HL2RPHud", HUD)
